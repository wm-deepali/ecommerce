            ...
            <div id="loading-center-absolute">
                <div class="aq-preloader-content">
                    <div class="aq-preloader-logo">
                        ...
                        <img src="{{ $general?->header_logo
    ? asset('storage/' . $general->header_logo)
...
<div class="aq-offcanvas-wrap">
    ...
    <div class="aq-offcanvas-top d-flex align-items-center justify-content-between">
        <div class="aq-offcanvas-logo">
            <a href="{{ url('/') }}">
              <img src="{{ $general?->header_logo ? asset('storage/' . $general->header_logo) : asset('assets/img/corporate/Oudhyana_img/logo.png') }}"
...
<!-- offcanvas area end -->
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-6 text-center text-md-start">
                        <div class="aq-header-logo pt-10 pb-10 d-flex justify-content-center justify-content-md-start">
                            <a href="{{ url('/') }}">
                                <img class="mobile-logo-img" style="width: 160px; max-width: 100%; height: auto;" src="{{ $general?->header_logo
    ? asset('storage/' . $general->header_logo)
    ...
    <a href="{{ route('home') }}">
        ...
        <img src="{{ asset('storage/' . $general->footer_logo) }}"
            alt="{{ $general?->site_name }}"
            style="filter: brightness(0) invert(1); width: 180px;">
        @elseif(!empty($general?->header_logo))
        <img src="{{ asset('storage/' . $general->header_logo) }}"
            alt="{{ $general?->site_name }}"
            style="filter: brightness(0) invert(1); width: 180px;">
        @endif
    </a>
